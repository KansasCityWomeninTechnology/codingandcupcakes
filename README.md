...
5.  In the dialog box that appears, paste the URL of your Coding and Cupcakes GitHub repository: **https://github.com/{your GitHub username}/codingandcupcakes**, and click Next.
